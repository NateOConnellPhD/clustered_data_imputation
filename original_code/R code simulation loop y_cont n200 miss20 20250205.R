...
# Print plots
print(plot1)
ggsave("Ycont n200 miss20 Plot 1.jpg", dpi = 300)
print(plot2)
ggsave("Ycont n200 miss20 Plot 2.jpg", dpi = 300)
print(plot3)
ggsave("Ycont n200 miss20 Plot 3.jpg", dpi = 300)



write.csv(results,"Ycont n200 miss20 simulations.csv")



tiff(file="Ycont n200 miss20 Plot 1.tiff", res=100,width=10,height=6, units="in")
print(plot1)
dev.off()

tiff(file="Ycont n200 miss20 Plot 2.tiff", res=100,width=10,height=6, units="in")
print(plot2)
dev.off()

tiff(file="Ycont n200 miss20 Plot 3.tiff", res=100,width=10,height=6, units="in")
print(plot3)
dev.off()
